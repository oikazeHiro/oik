...
public class DateUtils {
     ...
     *
     */
    public static final String FORMAT_NO_DTAE = "HH:mm:ss";
    /**
     * 时间格式化器集合
     */
    ...
    public static String formatTime(Date date) {
        ...
        return getSimpleDateFormat(FORMAT_NO_DTAE).format(date);
    }
    ...
    public static Date paseTime(String time) {
        return parse(time, FORMAT_NO_DTAE);
    }
     ...
     * @return {@link Integer}
     */
    public static Integer getBetweenDifferMinute(Date startDate, Date endDate) {
        long diff = startDate.getTime() - endDate.getTime();
        return Math.toIntExact(diff / 60 / 1000);
    }
